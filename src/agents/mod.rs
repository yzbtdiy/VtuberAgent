...
impl DanmakuAgents {
    ...
    pub async fn analyze_intent(&self, danmaku_content: &str) -> Result<IntentType> {
        let intent_analyzer =
            AgentBuilder::new(self.openai_client.completion_model(&self.model_name))
                .preamble(
    ...
    pub async fn generate_drawing_response(
        &self,
        danmaku_content: &str,
    ...
    pub async fn generate_other_response(&self, danmaku_content: &str) -> Result<String> {
        let other_agent = AgentBuilder::new(self.openai_client.completion_model(&self.model_name))
            .preamble(
